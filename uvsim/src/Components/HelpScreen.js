  ...
  return (
    ...
    >
      <Paper className={classes.box}>
        ...
        <Button color="primary" variant={selectedOne} onClick={chooseTemplateOne}>One</Button>
        <Button color="primary" variant={selectedTwo} onClick={chooseTemplateTwo}>Two</Button>
        <Button color="primary" variant={selectedThree} onClick={chooseTemplateThree}>Three</Button>
        <Button color="primary" variant={selectedFour} onClick={chooseTemplateFour}>Four</Button>
        <TextField
          multiline
          rows={20}
